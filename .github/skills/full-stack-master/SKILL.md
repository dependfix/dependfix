...
3. **规范一致性自检**：注释与测试名不得引入规划/任务/审计编号标记（`T405`、`P1-1` 等，例外仅真实常量与带文档路径的导航指针，见 [开发规范 §3](../../../docs/standards/development.md)）；新实现与既有规范冲突时先对照规范再定写法（详见 [经验归档 §十六](../../../docs/design/governance/experience-archive.md)）。
