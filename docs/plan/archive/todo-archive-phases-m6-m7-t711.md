# 早期阶段归档（M6 / M7.1 / M7.2 / T711 / M8）

> 本文档包含已从 `todo-archive.md` 主窗口迁出的早期阶段完整块（2026-08-20 neat-freak 归档批次执行；M8 段 2026-08-20 batches 补入）。
>
> 当前活跃任务见 [todo.md](../todo.md)；近期归档块见 [todo-archive.md](../todo-archive.md) 主窗口（M9 / 2026-08-19~20 三个新批次；M8 已迁出到本分片）。
>
...
> **归档日期**：2026-08-14
> **归档方式**：从 [todo.md §M8](../todo.md) 整体迁出（2026-08-19 启动 M10 时随主文档收口一并迁移至 todo-archive.md 主窗口；2026-08-20 neat-freak 批次再迁出至本分片）
...
- **D4 外联审计 vs 出站白名单（Q4=先后）**：M8 已落审计（T805），M10 C26 落白名单（出站 deny-by-default）——见 [backlog C40 / C26](../../plan/backlog.md) 双轨迹
