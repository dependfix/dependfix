...
- **UX-R3 已上收 M16.1**：候选已迁入 [todo.md §M16 任务清单](todo.md#m16-任务清单) 与 [roadmap.md §M16 详细任务](roadmap.md#m16-平台可用性深化m161--m162-已实施m163-165-待-d-阶段)；按 backlog 维护规则已闭环条目从本段主条目迁出，仅保留历史指针；下一阶段 M16 P 阶段规划已确认（含 /scans 页面 + /api/runs 组织隔离）。
