...
- 当前阶段任务：[todo.md](todo.md)（**M20 ScanResult 数据模型重构**：P 阶段规划完成 2026-08-31 + M20.1 已落地 commit `acb2d35`；下一步 M20.3 + M20.4 ScanResult 实体升级 + reconcile 函数）；待人工验收 T701/T702/T704 项随真实环境推进
